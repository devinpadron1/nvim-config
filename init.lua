...
-- Build with CMake using F7 (like VSCode)
vim.keymap.set('n', '<F7>', ':!cmake --build build-gcc-debug -j$(nproc)<CR>', { desc = 'Build project' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>e', ':Neotree toggle<CR>', { desc = '[e] Toggle file [E]xplorer' })
  ...
  },
  {
    ...
    config = function()
      ...
      vim.list_extend(ensure_installed, {
        ...
        'prettier', -- Used to format JavaScript, TypeScript, JSON, etc.
      })
  ...
  -- Colorscheme import and assignment --
  {
